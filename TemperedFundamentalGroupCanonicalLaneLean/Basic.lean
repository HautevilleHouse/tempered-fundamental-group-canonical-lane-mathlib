/-!
# tempered-fundamental-group-canonical-lane Lean migration boundary
...
`TemperedFundamentalGroupCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "tempered-fundamental-group-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/tempered-fundamental-group-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Tempered Fundamental Group: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["canonical-lane", "local-to-global", "manifold-constrained", "tempered-fundamental-group", "anabelian-geometry", "nonarchimedean-geometry", "mathematical-proof", "reproducibility"]
